...
const PrivacyPolicy = () => {
 return <div className="privacy-policy-page">
    ...
    <p style={{textAlign: "center"}}>Last updated: October 21, 2024</p>
    ...
    <ul>
    <li>
    <p><strong>Account</strong> means a unique account created for You to
    ...
    <li>
    <p><strong>Application</strong> refers to Starship launch game, the
    software program provided by the Company.</p>
    </li>
    <li>
    <p><strong>Company</strong> (referred to as either &quot;the
    Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
    this Agreement) refers to SUBOTIX LLC, 8700 HOUSTON RD.</p>
    </li>
    <li>
    <p><strong>Country</strong> refers to: Texas,  United States</p>
    </li>
    <li>
    <p><strong>Device</strong> means any device that can access the
    Service such as a computer, a cellphone or a digital tablet.</p>
    </li>
    <li>
    <p><strong>Personal Data</strong> is any information that relates to
    an identified or identifiable individual.</p>
    </li>
    <li>
    ...
    <ul>
    <li>
    <p><strong>To provide and maintain our Service</strong>, including to
    monitor the usage of our Service.</p>
    </li>
    <li>
    <p><strong>To manage Your Account:</strong> to manage Your
    ...
    <li>
    <p><strong>For the performance of a contract:</strong> the
    ...
    <li>
    <p><strong>To provide You</strong> with news, special offers and
    ...
    <li>
    <p><strong>To manage Your requests:</strong> To attend and manage Your
    requests to Us.</p>
    </li>
    <li>
    <p><strong>For business transfers:</strong> We may use Your
    ...
    <li>
    <p><strong>For other purposes</strong>: We may use Your information
    ...
    <ul>
    <li><strong>With Service Providers:</strong> We may share Your
    ...
    <li><strong>With Affiliates:</strong> We may share Your information
    ...
    <li><strong>With business partners:</strong> We may share Your
    ...
    information for any other purpose with Your consent.</li>
    </ul>
    ...
    <p>You have the right to delete or request that We assist in deleting
    the Personal Data that We have collected about You.</p>
    <p>Our Service may give You the ability to delete certain information
    about You from within the Service.</p>
    <p>You may update, amend, or delete Your information at any time by
    ...
    <p>Under certain circumstances, the Company may be required to
    ...
    <p>The Company may disclose Your Personal Data in the good faith
    ...
    <p>Our Service may contain links to other websites that are not
...
<ul>
    <li>By email: subotix.llc@gmail.com</li>
</ul>
    </p>
    </div>
